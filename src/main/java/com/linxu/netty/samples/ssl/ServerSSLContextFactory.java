 ...
 * keytool -genkey -alias aliasCA -keysize 2048 -validity 365 -keyalg
 * RSA -dname "CN=localhost" -keypass store_key_pass -storepass store_psw_ssl -keystore nettySsl.jks
 */
